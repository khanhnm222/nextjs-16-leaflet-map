    ...
    <div className="search-container absolute left-0 right-0 sm:left-4 sm:right-auto top-3 z-1001 px-4 sm:px-0">
        ...
        {hasPOIPanel ? (
          <>
            ...
            <button
              ...
              className="h-5 w-5 shrink-0 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition-colors"
      ...
      <div
        ...
        className={`overflow-hidden bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 ease-out ${
          isExpanded
            ? "max-h-125 opacity-100 rounded-b-lg"
            : "max-h-0 opacity-0"
        }`}
        aria-label="Search results"
      >
        <div className="overflow-y-auto max-h-12.5">
          {loading && (
            <div
